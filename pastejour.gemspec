Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "lib/pastejour", "lib/pastejour/version.rb", "lib/pastejour.rb", "spec/helper.rb", "spec/pastejour", "spec/pastejour/pastejour_spec.rb", "spec/spec.opts"]
  s.has_rdoc = true
